...
def create_scene_xml(
    ...
    # From hand zero position to TCP
    T_hand_TCP = config_transform(tool_visualization, "T_hand_TCP")

    tcp_body = ET.SubElement(hand_body, "body", {
        "name": "pbvs_tcp",
        "pos": vector_string(T_hand_TCP[:3, 3]),
        "quat": quaternion_string(T_hand_TCP[:3, :3]),
    })
    ET.SubElement(ee_body, "site", {
        "name": "pbvs_ee_frame",
        "type": "sphere",
        "size": ".006",
        "rgba": "1 1 1 1",
    ...
    if show_debug_frames:
        add_axis_geoms(ee_body, 0.07)

    ET.SubElement(tcp_body, "site", {
        "name": "pbvs_tcp_site",
        "type": "sphere",
        "size": ".005",
        "rgba": "0 0 1 1",
    ...
    # Visual only attach the holder mesh to the panda hand
    T_hand_H = config_transform(tool_visualization, "T_mujoco_hand_H")

    holder_body = ET.SubElement(tcp_body, "body", {
        "name": "pbvs_holder",
        "pos": vector_string(T_hand_H[:3, 3]),
        "quat": quaternion_string(T_hand_H[:3, :3]),
    })    
    ET.SubElement(holder_body, "geom", {
        "name": "pbvs_tool_mesh_geom",
        "type": "mesh",
        "mesh": "pbvs_tool_mesh",
        "rgba": ".7 .7 .7 1",
        "contype": "0",
    ...
    ET.SubElement(camera_body, "geom", {
        "name": "pbvs_camera_marker", "type": "box", 
        "size": vector_string(camera_half_size), 
        "rgba": ".10 .30 .90 .90",
    ...
    # ET.SubElement(holder_body, "geom", {
    #     "name": "pbvs_visual_rod_tip_debug",
    #     "type": "sphere",
    #     "pos": "0 0 0.17665",
    #     "size": ".0065",
    #     "rgba": "1 0 1 1",
    ...
    ET.SubElement(tip_body, "site", {
        "name": "pbvs_stick_tip_frame", 
        "type": "sphere", "size": ".006",
